...
fn floatexp() {
    assert!(common::run_test("glulxercise.ulx", vec![
                (Match(INTRO), "floatexp"),
                (Check(&|output| output.starts_with("Floating-point exponent functions:\n\n") && output.ends_with("\n\nPassed.\n\n>")), "quit"),
                ]).is_ok());
}
...
fn floattrig() {
    assert!(common::run_test("glulxercise.ulx", vec![
                (Match(INTRO), "floattrig"),
                (Check(&|output| output.starts_with("Floating-point trig functions:\n\n") && output.ends_with("\n\nPassed.\n\n>")), "quit"),
                ]).is_ok());
}
...
fn floatatan2() {
    assert!(common::run_test("glulxercise.ulx", vec![
                (Match(INTRO), "floatatan2"),
                (Check(&|output| output.starts_with("Floating-point atan2 function:\n\n") && output.ends_with("\n\nPassed.\n\n>")), "quit"),
                ]).is_ok());
}
...
fn fjump() {
    assert!(common::run_test("glulxercise.ulx", vec![
                (Match(INTRO), "fjump"),
                (Check(&|output| output.starts_with("Floating-point equality comparisons:\n\n") && output.ends_with("\n\nPassed.\n\n>")), "quit"),
                ]).is_ok());
}
...
fn fcompare() {
    assert!(common::run_test("glulxercise.ulx", vec![
                (Match(INTRO), "fcompare"),
                (Check(&|output| output.starts_with("Floating-point inequality comparisons:\n\n") && output.ends_with("\n\nPassed.\n\n>")), "quit"),
                ]).is_ok());
}
