...
impl Mode {
    pub fn load(self, exec: &mut Execute) -> u32 {
        match self {
            Mode::Const0 => 0,
            Mode::Const8 => {
    ...
    pub fn store(&self, exec: &mut Execute, val: u32) {
        match self {
            &Mode::Const0 => (),
            &Mode::Mem8 => {
                let addr = exec.state.mem[exec.state.pc] as usize;
    ...
    pub fn load8(&self, exec: &mut Execute) -> u32 {
        match self {
            &Mode::Const0 => 0,
            &Mode::Const8 => {
                let val = exec.state.mem[exec.state.pc];
    ...
    pub fn store8(&self, exec: &mut Execute, val: u32) {
        match self {
            &Mode::Const0 => (),
            &Mode::Mem8 => {
                let addr = exec.state.mem[exec.state.pc] as usize;
    ...
    pub fn load16(&self, exec: &mut Execute) -> u32 {
        match self {
            &Mode::Const0 => 0,
            &Mode::Const8 => {
                let val = exec.state.mem[exec.state.pc];
    ...
    pub fn store16(&self, exec: &mut Execute, val: u32) {
        match self {
            &Mode::Const0 => (),
            &Mode::Mem8 => {
                let addr = exec.state.mem[exec.state.pc] as usize;
    ...
    pub fn result_dest(&self, exec: &mut Execute) -> (u32,u32) {
        match self {
